...
var preload = [
    ...
    "angry1.png","bruja1.gif","fondos/salonclases1.jpg","fondos/salondeclases2.jpg"
  ];
  ...
  */
  function prepareNovel()
  {
      ...
      script = [
          label, "start",
          //scene, "hills1.jpg",
          scene, "fondos/salonclases1.jpg",
          n, "It&rsquo;s Un hermoso dia en la ubicacion secreta, donde encontraras a tu guia.",
          tyler, {image: "bruja1.gif", position: leftSide},
          tyler, "Hola guia a donde estas?",
          gavin, {position: rightTop, image: "simple2.png"},
          tyler, {image: "simple1.png"},
          gavin, "Aqui en el cerro personaje!",
          tyler, "Por favor, baja. It&rsquo;s sera mas facil hablar.",
          gavin, {position: rightSide},
          gavin, "Okis, ya esta mejor?",
          tyler, "Mucho mejor, gracias!",
